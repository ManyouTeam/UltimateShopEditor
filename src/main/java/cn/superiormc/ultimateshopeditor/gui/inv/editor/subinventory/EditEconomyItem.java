    ...
    public boolean clickEventHandle(Inventory inventory, ClickType type, int slot) {
        ...
        if (slot == 1) {
            if (section.getString("economy-plugin", "VANILLA").equals("VANILLA")) {
                ...
                LanguageManager.languageManager.sendStringText(player, "editor.enter-economy-type");
        ...
        if (slot == 2) {
            ...
            LanguageManager.languageManager.sendStringText(player, "editor.enter-economy-amount");
            player.closeInventory();
        }
        if (slot == 8) {
